...
```text
Weather Forecasting ML App
Python, scikit-learn, FastAPI, Streamlit, Android APK

- Built a machine learning weather forecasting application for Northern Vietnam.
- Processed hourly weather data into daily province-level features for model training.
- Engineered time-based, lag, rolling, and seasonal features to improve prediction quality.
- Trained and compared regression and classification models for temperature and rainfall prediction.
- Packaged the final demo as an Android APK and published it through GitHub Releases.
```
...
APK Demo: https://github.com/your-username/weather-forecast-ml-app/releases/latest
